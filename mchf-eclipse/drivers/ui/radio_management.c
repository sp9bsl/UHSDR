...
static bool RadioManagement_SetBandPowerFactor(const BandInfo* band, int32_t power)
{
    ...
    {
        //TODO: make mixed amplitude/attenuator use, using only the 0.5dB steps from PE4302 causes inacurate power settings
        ...
        return DDCboard_SetTXpower(power_factor);
    }
    else
#endif
    {
